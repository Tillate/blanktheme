...
function blanktheme_scripts() {
	...
	wp_enqueue_style( 'blanktheme-main', get_template_directory_uri().'/css/main.css');
...
function enqueue_custom_fonts() {
	if(!is_admin()) {
		wp_register_style('poppins', 'https://fonts.googleapis.com/css2?family=Poppins:wght@100;200;300;400;500;600;700;800&display=swap');
